...
const LandingPage = () => {
  ...
  return (
    <>
      <div className="min-h-[calc(100vh-64px)] bg-[] lg:px-14 sm:px-8 px-4 mt-10">
        <div className="lg:flex-row flex-col lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
          <div className=" flex-1">
            <motion.h1
              ...
              className="font-bold font-roboto text-center text-slate-800 md:text-4xl sm:text-4xl text-3xl   md:leading-[55px] sm:leading-[45px] leading-10 lg:w-full md:w-[70%] w-full"
            >
